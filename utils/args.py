...
def make_parser():
    ...
    parser.add_argument(
        "-f", "--exp_file",
        default="/home/ylp/wlh/paper/HybridSORT-level-cue-search/exps/example/mot/yolox_x_ablation_hybrid_sort_reid.py",
        type=str,
    ...
    # 使用demo时候，修改yolox_dancetrack_val_hybrid_sort_reid.py（-f）中的self.ckpt，使得两者对应
    ...
    parser.add_argument( "--path", default="/home/ylp/wlh/paper/HybridSORT-level-cue-search/videos/MOT17-02-FRCNN", help="path to images or video")
